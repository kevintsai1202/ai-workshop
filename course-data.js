...
window.COURSE = {
  meta: {
    ...
    dates: '115/5/13、5/20、5/27、6/3（09:30 ~ 17:00）',
    ...
    days: [
      { id: 'day1', n: 1, date: '5/13', title: '產業趨勢與 AI 基礎入門', hours: 6 },
      { id: 'day2', n: 2, date: '5/20', title: 'AI 多媒體內容製作', hours: 6 },
      { id: 'day3', n: 3, date: '5/27', title: '行政文件與財務資料整理', hours: 7 },
      { id: 'day4', n: 4, date: '6/3', title: 'AI 代理協作、成果展示與小測驗', hours: 7 }
    ]
  },
  ...
  day1: {
    ...
    date: '5/13（六） 09:30 ~ 17:00',
    hours: '6 小時',
    learningGoal: '建立 AI 工具的基本認知，能分辨「模型」（Gemini / GPT）與「工具」（Gemini App、NotebookLM、Antigravity、Codex 等）的差異，完成全部工具的帳號註冊與登入，並透過提示詞與行政應用示範，初步將 AI 應用於日常公告與會議文件處理。',
    schedule: [
      ['09:30 ~ 10:30', '開場 + 前測 + 破冰', '課程說明、前測填寫、學員自我介紹與痛點盤點'],
      ['10:30 ~ 12:00', '單元 1：AI 基礎與多工具', '模型 vs 工具、Gemini vs ChatGPT、4 工具定位、帳號註冊'],
      ['12:00 ~ 13:30', '午休', '（自理午餐）'],
      ['13:30 ~ 15:00', '單元 2 上半：提示詞入門', 'RTFC 四要素 + 公告示範'],
      ['15:00 ~ 16:30', '單元 2 下半：行政實作', '口語改寫公告 + 長文摘要'],
      ['16:30 ~ 17:00', '單元 3：Gem 介紹與實作', 'Gem 三大來源 + 自訂 Gem 親手做']
    ],
    units: [
      {
        id: 'u1',
        ...
        tasks: [
          ...
          { id: 'd1-u1-t3', label: '完成 Antigravity 註冊（antigravity.google，不要安裝）' },
          { id: 'd1-u1-t4', label: '完成 Codex 帳號註冊（chatgpt.com / OpenAI）' },
          { id: 'd1-u1-t5', label: '上傳 4 個工具登入後的首頁截圖至共用文件' }
        ],
        faq: [
...
[此處貼上原文]`
        ...
        materials: [
          ...
          { id: 'd1-m2', name: '綠野選物_員工差勤與休假管理辦法', type: 'PDF', desc: '七章二十六條，3000 字，行政人員每年都嫌長的代表性文件' },
          { id: 'd1-m3', name: '綠野選物_新進員工教育訓練手冊', type: 'PDF', desc: '進階備援：7000 字、跨 14 章，挑戰真．大檔案摘要能力' }
        ]
      },
      {
        id: 'u3',
        ...
        concepts: [
          ...
          },
          {
            ...
            list: [
              ...
              ['步驟 3', '指令：貼上今天實作 1 寫好的 RTFC 提示詞（直接複製、不用重寫）'],
    ...
    homework: [
      '把今天用過的 3 個提示詞整理成個人「提示詞庫 v1」（推薦工具：Google Keep 或 Notion）。',
      '回家用 AI 改寫一篇你過去寫過、現在看會臉紅的舊公告，下週上課帶來。',
  ...
  day2: {
    ...
    schedule: [
      ['09:30 ~ 10:00', '收心操 + Day 1 回顧', '提示詞庫分享、痛點打卡'],
      ['10:00 ~ 12:00', '單元 1：海報 + 投影片實作', 'Nano Banana 出海報、Canvas 直接生 .pptx'],
      ['12:00 ~ 13:30', '午休', ''],
      ['13:30 ~ 14:30', '單元 2 上半：影片基本概念 + Flow 介紹', 'PASA、圖片→影片原理'],
      ['14:30 ~ 17:00', '單元 2 下半：Flow 影片實作', '8-16 秒短片成品 + 互評']
    ],
    units: [
      {
        id: 'u1',
...
限制：字幕中文，每行 ≤ 12 字。`
        ...
        materials: [
          { id: 'd2-m1', name: '綠野選物_新品上架公告作業辦法', type: 'PDF', desc: 'IG 貼文 150 字 + 5 hashtag 等品牌規範' },
          { id: 'd2-m2', name: '綠野選物_新進員工教育訓練手冊', type: 'PDF', desc: '門市同仁訓練流程 + 核心價值 GREEN' }
        ]
      },
      {
        id: 'u2',
  ...
  day3: {
    ...
    date: '5/27（六） 09:30 ~ 17:00',
    hours: '7 小時',
    learningGoal: '聚焦於行政文件改寫、會議錄音摘要轉會議紀錄，以及發票與表單資料整理至 Excel，協助學員以 AI 大幅縮短常見的行政與財務作業流程。',
    schedule: [
      ['09:30 ~ 10:00', 'Day 2 回顧 + 收心操', '影片作品快速分享'],
      ['10:00 ~ 12:00', '單元 1 上半：行政文件 AI 改寫', '正式 vs 口語、文件分類、改寫提示詞庫'],
      ['12:00 ~ 13:00', '午休', ''],
      ['13:00 ~ 14:30', '單元 1 下半：NotebookLM 會議錄音摘要', '錄音 → 逐字稿 → 會議紀錄'],
      ['14:30 ~ 16:00', '單元 2 上半：表單清理 + FAQ 產生', '請購單整理、FAQ 初稿'],
      ['16:00 ~ 17:00', '單元 2 下半：發票辨識 + Skill 預演', 'NotebookLM 發票轉 Excel、Skill 一鍵實機展示']
    ],
    units: [
      {
        id: 'u1',
...
限制：原文沒講的不要自己補；不確定的標明「需確認」。`
        ...
        materials: [
          { id: 'd3-m1', name: '綠野選物_員工差勤與休假管理辦法', type: 'PDF', desc: '示範 A 的核心知識來源（重點：第十一條國定假日加班費）' },
          { id: 'd3-m2', name: '暖光咖啡_商品退換貨政策', type: 'PDF', desc: '示範 B 核心（重點：第六條拆封不退、第十條補償方案）' },
          { id: 'd3-m3', name: '會議錄音逐字稿範本', type: 'TEXT', desc: '夏季企劃會議 30 分鐘逐字稿，含閒聊與待辦事項' },
          { id: 'd3-m4', name: '綠野選物_新進員工教育訓練手冊', type: 'PDF', desc: '進階備援：7000 字、跨 14 章' }
        ]
      },
      {
        id: 'u2',
...
3. 無法辨識的文字請填「待人工確認」。`
        ...
        materials: [
          ...
          { id: 'd3-m7', name: '暖光咖啡_FAQ官方版', type: 'PDF', desc: '評分對照用：學員產出後可拿此對照' },
          { id: 'd3-m8', name: '公司費用報支管理辦法', type: 'PDF', desc: '第四條誤餐費 150 元上限 — 合規檢查依據' },
          { id: 'd3-m9', name: '暖光咖啡_客訴處理SOP', type: 'PDF', desc: '客服 FAQ 撰寫之政策依據' },
          { id: 'd3-m10', name: '暖光咖啡_食材進貨與庫存管理辦法', type: 'PDF', desc: '進貨表分類示範' }
        ]
      }
    ],
    homework: [
  ...
  day4: {
    ...
    schedule: [
      ...
      ['10:00 ~ 12:00', '單元 1 上半：工具安裝 + Skill 概念', 'Antigravity / Codex 安裝、Skill 三要素'],
      ['12:00 ~ 13:00', '午休', ''],
...
[此處貼上你的提示詞]`
        ...
        materials: [
          ...
          { id: 'd4-m2', name: '公司費用報支管理辦法', type: 'PDF', desc: '範例 Skill 的合規規則來源' }
        ]
      },
      {
        id: 'u2',
        title: '單元 2｜學員建立專屬 Skill + 成果展示 + 後測',
        time: '14:30 ~ 17:00',
        goals: [
        ...
        tasks: [
          ...
          { id: 'd4-u2-t4', label: '完成課後小測驗（10 題）— 達結訓標準' },
  ...
  // ========== 教學素材總覽 ==========
  materials: [
    { id: 'm-1', name: '綠野選物_員工差勤與休假管理辦法', type: 'PDF', size: '七章二十六條', usedIn: ['Day 1 實作 2', 'Day 3 示範 A'], desc: '3000 字規章，行政人員每年都嫌長的代表性文件' },
    { id: 'm-2', name: '綠野選物_新進員工教育訓練手冊', type: 'PDF', size: '7000 字、跨 14 章', usedIn: ['Day 1 進階備援', 'Day 2 投影片', 'Day 3 進階備援'], desc: '門市同仁訓練流程 + 核心價值 GREEN' },
    { id: 'm-3', name: '綠野選物_新品上架公告作業辦法', type: 'PDF', size: '單章', usedIn: ['Day 2 海報文案規範'], desc: 'IG 貼文 150 字 + 5 hashtag 等品牌規範' },
    { id: 'm-4', name: '暖光咖啡_FAQ 官方版', type: 'PDF', size: '完整 FAQ', usedIn: ['Day 3 實作 3 評分對照'], desc: '⭐ 標準解答' },
    { id: 'm-5', name: '暖光咖啡_商品退換貨政策', type: 'PDF', size: '十條', usedIn: ['Day 3 示範 B'], desc: '第六條拆封不退、第十條補償方案是核心' },
    { id: 'm-6', name: '暖光咖啡_客訴處理SOP', type: 'PDF', size: '完整 SOP', usedIn: ['Day 3 FAQ 示範'], desc: '客服 FAQ 撰寫之政策依據' },
    { id: 'm-7', name: '暖光咖啡_食材進貨與庫存管理辦法', type: 'PDF', size: '單章', usedIn: ['Day 3 進貨表示範'], desc: '提供品項分類規則供 AI 自動歸類' },
    { id: 'm-8', name: '公司費用報支管理辦法', type: 'PDF', size: '完整辦法', usedIn: ['Day 3 表單清理 + 發票合規', 'Day 4 Skill 範本'], desc: '第四條誤餐費 150 元上限 — 合規檢查依據' },
    { id: 'm-9', name: '課堂實作素材_Day1 / Day2 / Day3', type: 'PDF', size: '三份', usedIn: ['對應日'], desc: '當日實作專用素材' },
  ...
  quiz: [
    ...
    },
    {
      id: 'q6',
      type: 'multi',
      q: 'Gemini 內建的 Nano Banana 圖像模型，具備哪些強大的功能？（多選）',
      options: [
        '透過文字生成圖片',
        '將圖片轉為 3D 模型',
        '在保持人物與風格一致的前提下，局部編輯圖片'
      ],
      answer: [0, 2]
    },
    {
    ...
    },
    {
      id: 'q10',
      type: 'single',
      q: '製作一份 8-16 秒的短片，最推薦使用的腳本結構是？',
      options: [
        '起承轉合',
        'PASA（痛點、放大、解法、行動）',
        'HSC（Hook 抓眼球、Show 展示、Call 行動呼籲）'
      ],
      answer: 2
    }
  ]
